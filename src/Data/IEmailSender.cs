...
namespace ScentAir.Payment
{
    public interface IEmailSender
    {
        ...
        Task<ITaskResult> SendGridEmailAsync(MailboxAddress sender, MailboxAddress[] recepients, string subject, string body, SmtpConfig config = null, bool isHtml = true);
    }
}
