    ...
    public class SFAccountSettingsManager : ISFAccountSettingsManager
    {
        ...
        public async Task<SFAccountSettings> GetSFAccountSettingsAsync(string accountNumber, CancellationToken cancellationToken = default(CancellationToken))
        {
            var qry = portalContext.SFAccountSettings
                ...
                //.Include(a => a.BillingLine1)
                //.Include(a => a.BillingLine2)
                //.Include(a => a.BillingLine3)
                //.Include(a => a.BillingMunicipality)
                //.Include(a => a.BillingStateOrProvince)
                //.Include(a => a.BillingPostalCode)
                //.Include(a => a.BillingCountry)
                //.Include(a => a.ShippingLine1)
                //.Include(a => a.ShippingLine2)
                //.Include(a => a.ShippingLine3)
                //.Include(a => a.ShippingMunicipality)
                //.Include(a => a.ShippingStateOrProvince)
                //.Include(a => a.ShippingPostalCode)
                //.Include(a => a.ShippingCountry);
        ...
        //.Include(a => a.Account)
        //.Include(a => a.BillingLine2 == null ? "" : a.BillingLine2)
        //.Include(a => a.BillingLine3 == null ? "" : a.BillingLine3)
        //.Include(a => a.BillingMunicipality)
        //.Include(a => a.BillingStateOrProvince)
        //.Include(a => a.BillingPostalCode)
        //.Include(a => a.BillingCountry)
        //.Include(a => a.ShippingLine1)
        //.Include(a => a.ShippingLine2 == null ? "" : a.ShippingLine2)
        //.Include(a => a.ShippingLine3 == null ? "" : a.ShippingLine3)
