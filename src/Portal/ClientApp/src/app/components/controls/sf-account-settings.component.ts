...
export class SFAccountSettingsComponent implements OnInit {
  ...
  private accountSettings: SFAccountSettings = new SFAccountSettings();
  ...
  ngOnInit() {
    ...
    this.accountSettings.billingAddress.line1 = '123 Fourth Street';
    this.accountSettings.billingAddress.line2 = 'Suite 321';
    this.accountSettings.billingAddress.line3 = '';
    this.accountSettings.billingAddress.municipality = 'Charlotte';
    this.accountSettings.billingAddress.stateOrProvince = 'NC';
    this.accountSettings.billingAddress.postalCode = '28120';
    this.accountSettings.billingAddress.country = 'United States';
    this.accountSettings.shippingAddress.line1 = '123 Fourth Street';
    this.accountSettings.shippingAddress.line2 = 'Suite 321';
    this.accountSettings.shippingAddress.line3 = '';
    this.accountSettings.shippingAddress.municipality = 'Charlotte';
    this.accountSettings.shippingAddress.stateOrProvince = 'NC';
    this.accountSettings.shippingAddress.postalCode = '28120';
    this.accountSettings.shippingAddress.country = 'United States';
